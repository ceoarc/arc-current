...
KC 62619 is one of the electrical-product safety standards notified by the Korean Agency for Technology and Standards (KATS), formally titled "Safety of Industrial Lithium Secondary Batteries." It adapts the international standard IEC 62619 — safety requirements for secondary lithium cells and batteries used in industrial applications, within the broader IEC 62619 family for alkaline and other non-acid electrolyte secondary cells — to domestic conditions. First notified in October 2019, it was updated to its current edition (Ed 2.0) in March 2023 to align with IEC 62619 Ed.2.0.
